...
/* Order: Home, Cakes, Gallery, [Brownies dropdown], Reviews, Contact, About, [Order Now] */
    ...
    <>
      ...
      >
        ...
        <div className="navbar-links">
          {NAV_LINKS_MAIN.map((link, i) => (
            <motion.a
              key={link.label}
              href={link.href}
              onClick={(e) => { e.preventDefault(); link.route ? goToRoute(link.href) : scrollTo(link.href) }}
